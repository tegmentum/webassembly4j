...
class GraalWasmIntegrationTest {
    ...
    // Generated by wat2wasm from memory/store/load module
    ...
    @Test
    void addFunction() {
        try (Engine engine = GraalWasmEngineAdapter.create(null);
    ...
    @Test
    void hostFunctionLinkingNotSupported() {
        try (Engine engine = GraalWasmEngineAdapter.create(null);
            ...
            assertThrows(ai.tegmentum.webassembly4j.api.exception.LinkingException.class,
